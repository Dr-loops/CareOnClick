...
export const LAB_TESTS = {
    haematology: [
        {
            id: 'fbc', name: 'FBC (Full Blood Count)', parameters: [
                { id: 'wbc', label: 'WBC', unit: 'x10^9/L', default: '', getRange: (a, s) => getReferenceRange('wbc', a, s) },
                { id: 'rbc', label: 'RBC', unit: 'x10^12/L', default: '', getRange: (a, s) => getReferenceRange('rbc', a, s) },
                { id: 'hgb', label: 'Hemoglobin', unit: 'g/dL', default: '', getRange: (a, s) => getReferenceRange('hgb', a, s) },
                { id: 'plt', label: 'Platelets', unit: 'x10^9/L', default: '', getRange: (a, s) => getReferenceRange('plt', a, s) },
                { id: 'mcv', label: 'MCV', unit: 'fL', default: '', range: '80 - 96' },
                { id: 'mch', label: 'MCH', unit: 'pg', default: '', range: '27 - 33' },
                { id: 'mchc', label: 'MCHC', unit: 'g/dL', default: '', range: '33 - 36' }
            ]
        },
        {
            id: 'malaria', name: 'MALARIA TEST', parameters: [
                { id: 'mp', label: 'MP Result', unit: '', default: '' },
                { id: 'density', label: 'Parasite Density', unit: '/uL', default: '' }
            ]
        },
        {
            id: 'coagulation', name: 'COAGULATION TEST', parameters: [
                { id: 'pt', label: 'PT', unit: 'sec', default: '', range: '11 - 13.5' },
                { id: 'aptt', label: 'APTT', unit: 'sec', default: '', range: '30 - 40' },
                { id: 'inr', label: 'INR', unit: '', default: '', range: '0.8 - 1.2' }
            ]
        },
        {
        ...
        },
        {
            id: 'sickle', name: 'SICKLE CELL', parameters: [
                { id: 'genotype', label: 'Genotype', unit: '', default: '' }
            ]
        },
        {
    ...
    sti: [
        { id: 'hiv', name: 'HIV', parameters: [{ id: 'res', label: 'Result', default: '' }] },
        { id: 'syphils', name: 'SYPHILIS', parameters: [{ id: 'res', label: 'Result', default: '' }] },
        { id: 'gorno', name: 'GONORRHEA', parameters: [{ id: 'res', label: 'Result', default: '' }] }
    ]
};
