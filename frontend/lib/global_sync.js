...
export const checkAppointmentCompletion = (id) => {
    ...
    addNotification({
        ...
        message: `${app.patientName} booked a ${app.type} session for ${app.date} at ${app.time}.`,
        details: {
    ...
    addNotification({
        ...
        message: `Your appointment with ${app.professionalName} for ${app.date} at ${app.time} has been successfully booked and payment processed.`,
        details: {
    ...
    if (app.amountPaid > 0) {
        addNotification({
            ...
            message: `Payment of GHS ${app.amountPaid} confirmed for ${app.patientName}'s appointment on ${app.date}.`,
            details: {
                patientName: app.patientName,
                amount: `GHS ${app.amountPaid}`
            }
        });
    }
